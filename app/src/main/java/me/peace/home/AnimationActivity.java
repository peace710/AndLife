...
public class AnimationActivity extends AppCompatActivity {
    ...
    private static final Data DATAS[] = {
            new Data(R.string.transition, TransitionActivity.class),
            new Data(R.string.cross_fade, CrossFadeActivity.class),
            new Data(R.string.screen_slide, ScreenSlidePagerActivity.class),
            new Data(R.string.card_flip, CardFlipActivity.class),
            new Data(R.string.zoom, ZoomActivity.class),
            new Data(R.string.layout_changes, LayoutChangesActivity.class)
    };
